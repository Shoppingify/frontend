...
function Sidebar() {
    ...
    return (
        <div
            className={`w-sidebar-mobile md:w-sidebar-tablet absolute right-0 h-full lg:relative lg:transform-none lg:w-sidebar lg:block flex-none overflow-y-auto overflow-x-hidden transform transition-transform duration-300 ease-in-out ${
